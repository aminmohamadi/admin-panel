<template>
  <div class="h-screen flex w-full bg-img">
    <div
      ...
      <h1 class="sm:mx-0 mx-4 mb-12 text-5xl d-theme-heading-color">403 - Access Denied!</h1>
      <p class="sm:mx-0 mx-4 mb-4 sm:mb-16 d-theme-text-inverse">paraphonic unassessable foramination Caulopteris worral
