<template>
  <div id="data-list-list-view" class="data-list-container">
    <vx-card ref="filterCard" title="جست و جو" class="comments-list-filters mb-8">
      <div class="vx-row">
    ...
    <vx-card actionButtons @refresh="fetch" title="همه نقش ها" class="roles-list mb-8">
      <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" :data="resultQuery"
        ...
        <template class="flex  flex-row-reverse" slot="thead">
          ...
          <vs-th class="text-center" >متن</vs-th>
          <vs-th class="text-center" sort-key="unit">بخش</vs-th>
          <vs-th class="text-center" sort-key="created_at">تاریخ انتشار</vs-th>
          <vs-th class="text-center" sort-key="approved">وضعیت</vs-th>
        ...
        <template slot-scope="{data}">
          ...
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            <vs-td class="text-center">
              <p class="product-name font-medium truncate">{{ tr.author }}</p>
            </vs-td>
            <vs-td class="text-center">
              <p class="product-category">{{ tr.body }}</p>
            </vs-td>
            <vs-td class="text-center">
            ...
            <vs-td class="text-center">
              <vs-switch v-model="tr.approved" @change.stop="changecommentstatus(tr.approved,tr.id)">
...
export default {
  ...
  computed: {
    ...
    queriedItems () {
      return this.$refs.table ? this.$refs.table.queriedResults.length : this.comments.length
    },
    resultQuery () {
